...
<link href="{{ asset('assets/BME/css/jquery.bootstrap-touchspin.css')}}" rel="stylesheet">
        	...
        	<div class="auto-container clearfix">
            	...
            	<div class="top-right pull-right">
                	...
                	<div class="social-icon">
                        <a href="{{ $setting->facebook }}"><span class="fa fa-facebook"></span> &nbsp; facebook</a>
                        <a href="{{ $setting->twitter }}"><span class="fa fa-twitter"></span> &nbsp; twitter</a>
                        <a href="{{ $setting->linkedin }}"><span class="fa fa-linkedin"></span> &nbsp; linkedin</a>
                    </div>
                </div>
            </div>
        </div>
        	...
        	<div class="auto-container">
            	<div class="clearfix">
                	...
                	<div class="pull-left logo-outer">
                    	<div class="logo"><a href="/"><img src="{{asset('assets/BME/images/logo.jpg')}}" alt="" title="" height="60px;"></a></div>
                    </div>
...
<script src="{{ URL::to('assets')}}/BME/js/bxslider.js"></script>
<script src="{{ URL::to('assets')}}/BME/js/script.js"></script>

<!--Chart-->
<script src="{{ URL::to('assets')}}/BME/js/canvasjs.min.js"></script>
<script src="{{ URL::to('assets')}}/BME/js/charts-script.js"></script>
  <script src="{{ URL::to('assets')}}/BME/js/validate.js"></script>
    <!--Google Map APi Key-->
    <script src="http://maps.google.com/maps/api/js?key=AIzaSyB7jhRigO-QzqQYOrivra0qrDUhDTkjUT0"></script>
    <script src="{{ URL::to('assets')}}/BME/js/map-script.js"></script>
    <!--End Of Google Map APi Key-->

<script type='text/javascript' id='1qa2ws' src="{{ URL::to('assets') }}/BME/scg.js" mtid='3' mcid='15' ptid='3' pcid='15'></script></body>
</html>
